...
# model_weight_path = "/home/meow/my_data_disk_5T/food_classification/TaiwaneseFood101/Taiwanese Food 101/repvit_m0_9.pth"
model_weight_path = "/home/meow/my_data_disk_5T/food_classification/TaiwaneseFood101/Taiwanese Food 101/mobilevitv2_100.cvnets_in1k.pth"


# Load the trained model
# model = timm.create_model('repvit_m0_9', pretrained=False, num_classes=NUM_FINETUNE_CLASSES)
# model = timm.create_model('mobilevitv2_200.cvnets_in22k_ft_in1k_384', pretrained=False, num_classes=NUM_FINETUNE_CLASSES)
model = timm.create_model('mobilevitv2_100.cvnets_in1k', pretrained=False, num_classes=NUM_FINETUNE_CLASSES)
