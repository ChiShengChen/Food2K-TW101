...
from mobileformer.helpers import build_model_with_cfg
from mobileformer.dna_blocks import DnaBlock, DnaBlock3, _make_divisible, MergeClassifier, Local2Global

__all__ = ['MobileFormer']
  
def _cfg(url='', **kwargs):
    return {
        'url': url, 'num_classes': 1000, 'input_size': (3, 448, 448), 'pool_size': (1, 1),
